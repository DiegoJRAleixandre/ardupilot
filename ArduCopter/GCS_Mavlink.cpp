    ...
    case MAV_CMD_USER_1: {
        ...
        case 1:
            if ((uint8_t)packet.param2 == 0){
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_cameraMode, false);
            } else {
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_cameraMode, true);
            }
            break;
        case 2:
            if ((uint8_t)packet.param2 == 0){
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_larguerBouee, false);
            } else {
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_larguerBouee, true);
            }
            break;
        case 3:
            if ((uint8_t)packet.param2 == 0){
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_larguerFluoresceine, false);
            } else {
                SRV_Channels::set_custom_output_pwm(SRV_Channel::k_larguerFluoresceine, true);
            }
            break;
